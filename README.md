...
This is a [TIPE](https://www.scei-concours.fr/tipe.php) \(Epreuve d'evaluation des travaux d'initiative personelle encadres \) for the French "Concours d'ingenieur". Associated documents can be found in `tipe`.
